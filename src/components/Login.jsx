    ...
    return (
        ...
        >
            <div className="mx-auto w-full max-w-lg bg-gray-100 rounded-xl p-10 border border-black/10">
                ...
                <h2 className="text-center text-2l font-bold leading-tight">Sign in to your account</h2>
                ...
                <form onSubmit={handleSubmit(loginMethod)} className="mt-8">
                    <div className="my-5">
                        ...
                        />
                        <Button type="submit" className="w-full cursor-pointer mt-5">Sign in</Button>
                    </div>
                </form>
            </div>
        </div>
